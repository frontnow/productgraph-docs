...
description: 'Bemerkenswerte Änderungen und Updates der Product Graph API'
icon: 'clock-rotate-left'
---

# Product Graph API Änderungsprotokoll

Diese Seite dokumentiert bedeutende Updates und Änderungen an der Product Graph API. Wir verbessern unsere API ständig, um bessere Funktionalität, Leistung und Entwicklererfahrung zu bieten.

<Note>
  Informationen zur Abwärtskompatibilität und zu Deprecation-Richtlinien finden Sie in unserer [API-Versionierungsrichtlinie](/de/product-graph/best-practices#api-versioning).
</Note>
...
### Erweiterte Filter-Operatoren in der Such-API
...
### Historische Daten-API
  Einführung unserer neuen Historischen Daten-API, mit der Sie Änderungen an Produktinformationen im Laufe der Zeit verfolgen können.
...
### Markenanalytik und -einblicke
  Die Marken-API bietet jetzt Analytik und Einblicke zu Marken in unserer Datenbank.
...
### Massenoperationen-API
  Neue Endpunkte für Operationen mit hohem Volumen:
  
  ```bash
  # Produkte in Masse abrufen
...
### Leistungsverbesserungen
  **50% schnellere Suchantwortzeiten** und **30% Reduzierung der API-Latenz** über alle Endpunkte hinweg.
  ...
  Diese Verbesserungen stehen automatisch allen API-Nutzern zur Verfügung, ohne dass Integrationsänderungen erforderlich sind.
</Update>
...
### Bildanalyse-API
  Neue Bildanalyse-Funktionen, die detaillierte Informationen zu Produktbildern liefern:
  ...
  Diese Funktion hilft dabei, bessere Produktlisten mit genauen Farbinformationen und Qualitätsbewertung zu erstellen.
</Update>
...
### Erweiterte Sprachunterstützung
  Wir haben Unterstützung für 15 neue Sprachen hinzugefügt, wodurch sich die Gesamtzahl auf 30 Sprachen erhöht:
  
  - Neu hinzugefügt: Arabisch, Türkisch, Niederländisch, Schwedisch, Norwegisch, Finnisch, Dänisch, Polnisch, Tschechisch, Ungarisch, Griechisch, Rumänisch, Thai, Indonesisch und Malaysisch
  - Bestehend: Englisch, Deutsch, Französisch, Spanisch, Italienisch, Portugiesisch, Russisch, Japanisch, Koreanisch, Chinesisch (Vereinfacht), Chinesisch (Traditionell), Hindi, Vietnamesisch, Ukrainisch und Hebräisch
...
### Erste öffentliche Veröffentlichung
  ...
  - Produkt-Such-API mit Filterung und Sortierung
  ...
  - Guthabensystem für Nutzungsverfolgung
